...
class Chomp_GameParser ( Parser ):

    grammarFileName = "Chomp_Game.g4"
    ...
    class DomainContext(ParserRuleContext):
        ...
        def LB(self, i:int=None):
            if i is None:
                return self.getTokens(Chomp_GameParser.LB)
            else:
                return self.getToken(Chomp_GameParser.LB, i)

        def DEFINE(self):
            return self.getToken(Chomp_GameParser.DEFINE, 0)

        def DOMAIN(self):
            return self.getToken(Chomp_GameParser.DOMAIN, 0)

        def NAME(self):
            return self.getToken(Chomp_GameParser.NAME, 0)

        def RB(self, i:int=None):
            if i is None:
                return self.getTokens(Chomp_GameParser.RB)
            else:
                return self.getToken(Chomp_GameParser.RB, i)

        def objectDefine(self):
            return self.getTypedRuleContext(Chomp_GameParser.ObjectDefineContext,0)


        def typeDefine(self):
            return self.getTypedRuleContext(Chomp_GameParser.TypeDefineContext,0)


        def terconditionDefine(self):
            return self.getTypedRuleContext(Chomp_GameParser.TerconditionDefineContext,0)


        def actionDefine(self, i:int=None):
            if i is None:
                return self.getTypedRuleContexts(Chomp_GameParser.ActionDefineContext)
            else:
                return self.getTypedRuleContext(Chomp_GameParser.ActionDefineContext,i)


        def getRuleIndex(self):
            return Chomp_GameParser.RULE_domain
    ...
    def domain(self):
        ...
        localctx = Chomp_GameParser.DomainContext(self, self._ctx, self.state)
        self.enterRule(localctx, 0, self.RULE_domain)
        self._la = 0 # Token type
        try:
            self.enterOuterAlt(localctx, 1)
            self.state = 66
            self.match(Chomp_GameParser.LB)
            self.state = 67
            self.match(Chomp_GameParser.DEFINE)
            self.state = 68
            self.match(Chomp_GameParser.LB)
            self.state = 69
            self.match(Chomp_GameParser.DOMAIN)
            self.state = 70
            self.match(Chomp_GameParser.NAME)
            self.state = 71
            self.match(Chomp_GameParser.RB)
            self.state = 72
            self.objectDefine()
            self.state = 73
            self.typeDefine()
    ...
    class ObjectDefineContext(ParserRuleContext):
        ...
        def LB(self):
            return self.getToken(Chomp_GameParser.LB, 0)

        def COLON(self):
            return self.getToken(Chomp_GameParser.COLON, 0)

        def OBJS(self):
            return self.getToken(Chomp_GameParser.OBJS, 0)

        def listVariable(self):
            return self.getTypedRuleContext(Chomp_GameParser.ListVariableContext,0)


        def RB(self):
            return self.getToken(Chomp_GameParser.RB, 0)

        def getRuleIndex(self):
            return Chomp_GameParser.RULE_objectDefine
    ...
    def objectDefine(self):
        ...
        localctx = Chomp_GameParser.ObjectDefineContext(self, self._ctx, self.state)
        ...
        try:
            ...
            self.match(Chomp_GameParser.LB)
            self.state = 84
            self.match(Chomp_GameParser.COLON)
            self.state = 85
            self.match(Chomp_GameParser.OBJS)
            self.state = 86
            self.listVariable()
            self.state = 87
            self.match(Chomp_GameParser.RB)
    ...
    class NumericDefineContext(ParserRuleContext):
        ...
        def NUMS(self):
            return self.getToken(Chomp_GameParser.NUMS, 0)
        ...
        def numericSymbol(self, i:int=None):
            if i is None:
                return self.getTypedRuleContexts(Chomp_GameParser.NumericSymbolContext)
            else:
                return self.getTypedRuleContext(Chomp_GameParser.NumericSymbolContext,i)


        def getRuleIndex(self):
            return Chomp_GameParser.RULE_numericDefine
    ...
    def numericDefine(self):
        ...
        localctx = Chomp_GameParser.NumericDefineContext(self, self._ctx, self.state)
        ...
        try:
            ...
            self.match(Chomp_GameParser.COLON)
            self.state = 91
            self.match(Chomp_GameParser.NUMS)
            self.state = 93 
            self._errHandler.sync(self)
            _la = self._input.LA(1)
            while True:
                ...
                self._errHandler.sync(self)
                _la = self._input.LA(1)
                if not (_la==Chomp_GameParser.NAME):
                    break
    ...
    class NumericSymbolContext(ParserRuleContext):
        ...
        def getRuleIndex(self):
            return Chomp_GameParser.RULE_numericSymbol
    ...
    def numericSymbol(self):
        ...
        localctx = Chomp_GameParser.NumericSymbolContext(self, self._ctx, self.state)
    ...
    class TypeDefineContext(ParserRuleContext):
        ...
        def TYPE(self):
            return self.getToken(Chomp_GameParser.TYPE, 0)

        def NORMAL(self):
            return self.getToken(Chomp_GameParser.NORMAL, 0)

        def RB(self):
            return self.getToken(Chomp_GameParser.RB, 0)

        def MISER(self):
            return self.getToken(Chomp_GameParser.MISER, 0)

        def getRuleIndex(self):
            return Chomp_GameParser.RULE_typeDefine
    ...
    def typeDefine(self):
        ...
        localctx = Chomp_GameParser.TypeDefineContext(self, self._ctx, self.state)
        ...
        try:
            ...
            if la_ == 1:
                ...
                self.match(Chomp_GameParser.COLON)
                self.state = 103
                self.match(Chomp_GameParser.TYPE)
                self.state = 104
                self.match(Chomp_GameParser.NORMAL)
                self.state = 105
                self.match(Chomp_GameParser.RB)
                pass
                ...
                self.match(Chomp_GameParser.TYPE)
                self.state = 109
                self.match(Chomp_GameParser.MISER)
                self.state = 110
                self.match(Chomp_GameParser.RB)
                pass
    ...
    class TerconditionDefineContext(ParserRuleContext):
        ...
        def TERCONDITION(self):
            return self.getToken(Chomp_GameParser.TERCONDITION, 0)

        def emptyOrPreGD(self):
            return self.getTypedRuleContext(Chomp_GameParser.EmptyOrPreGDContext,0)
        ...
        def getRuleIndex(self):
            return Chomp_GameParser.RULE_terconditionDefine
    ...
    def terconditionDefine(self):
        ...
        localctx = Chomp_GameParser.TerconditionDefineContext(self, self._ctx, self.state)
        ...
        try:
            ...
            self.match(Chomp_GameParser.COLON)
            self.state = 115
            self.match(Chomp_GameParser.TERCONDITION)
            self.state = 116
            self.emptyOrPreGD()
            self.state = 117
            self.match(Chomp_GameParser.RB)
    ...
    class PredicateDefineContext(ParserRuleContext):
        ...
        def PREDICATE(self):
            return self.getToken(Chomp_GameParser.PREDICATE, 0)
        ...
        def atomFormSkeleton(self, i:int=None):
            if i is None:
                return self.getTypedRuleContexts(Chomp_GameParser.AtomFormSkeletonContext)
            else:
                return self.getTypedRuleContext(Chomp_GameParser.AtomFormSkeletonContext,i)


        def getRuleIndex(self):
            return Chomp_GameParser.RULE_predicateDefine
    ...
    def predicateDefine(self):
        ...
        localctx = Chomp_GameParser.PredicateDefineContext(self, self._ctx, self.state)
        ...
        try:
            ...
            self.match(Chomp_GameParser.COLON)
            self.state = 121
            self.match(Chomp_GameParser.PREDICATE)
            self.state = 123 
            self._errHandler.sync(self)
            _la = self._input.LA(1)
            while True:
                ...
                self._errHandler.sync(self)
                _la = self._input.LA(1)
                if not (_la==Chomp_GameParser.LB):
                    break
    ...
    class AtomFormSkeletonContext(ParserRuleContext):
        ...
        def predicate(self):
            return self.getTypedRuleContext(Chomp_GameParser.PredicateContext,0)
        ...
        def oneofDefine(self):
            return self.getTypedRuleContext(Chomp_GameParser.OneofDefineContext,0)


        def getRuleIndex(self):
            return Chomp_GameParser.RULE_atomFormSkeleton
    ...
    def atomFormSkeleton(self):
        ...
        localctx = Chomp_GameParser.AtomFormSkeletonContext(self, self._ctx, self.state)
    ...
    class PredicateContext(ParserRuleContext):
        ...
        def getRuleIndex(self):
            return Chomp_GameParser.RULE_predicate
    ...
    def predicate(self):
        ...
        localctx = Chomp_GameParser.PredicateContext(self, self._ctx, self.state)
    ...
    class TypeDeclarationContext(ParserRuleContext):
        ...
        def constTerm(self, i:int=None):
            if i is None:
                return self.getTypedRuleContexts(Chomp_GameParser.ConstTermContext)
            else:
                return self.getTypedRuleContext(Chomp_GameParser.ConstTermContext,i)
        ...
        def getRuleIndex(self):
            return Chomp_GameParser.RULE_typeDeclaration
    ...
    def typeDeclaration(self):
        ...
        localctx = Chomp_GameParser.TypeDeclarationContext(self, self._ctx, self.state)
        self.enterRule(localctx, 18, self.RULE_typeDeclaration)
        try:
            self.state = 146
            self._errHandler.sync(self)
            token = self._input.LA(1)
            if token in [Chomp_GameParser.NAME]:
                self.enterOuterAlt(localctx, 1)
                self.state = 139
                self.match(Chomp_GameParser.NAME)
                pass
            elif token in [Chomp_GameParser.LB]:
                self.enterOuterAlt(localctx, 2)
                self.state = 140
                self.match(Chomp_GameParser.LB)
                self.state = 141
    ...
    class TypeContext(ParserRuleContext):
        ...
        def OBJECT(self):
            return self.getToken(Chomp_GameParser.OBJECT, 0)

        def AGENT(self):
            return self.getToken(Chomp_GameParser.AGENT, 0)

        def NAME(self):
            return self.getToken(Chomp_GameParser.NAME, 0)

        def getRuleIndex(self):
            return Chomp_GameParser.RULE_type
    ...
    def type(self):
        ...
        localctx = Chomp_GameParser.TypeContext(self, self._ctx, self.state)
        ...
        try:
            ...
            self.state = 148
            _la = self._input.LA(1)
            if not((((_la) & ~0x3f) == 0 and ((1 << _la) & ((1 << Chomp_GameParser.OBJECT) | (1 << Chomp_GameParser.AGENT) | (1 << Chomp_GameParser.NAME))) != 0)):
    ...
    class ActionDefineContext(ParserRuleContext):
        ...
        def COLON(self, i:int=None):
            if i is None:
                return self.getTokens(Chomp_GameParser.COLON)
            else:
                return self.getToken(Chomp_GameParser.COLON, i)

        def ACTION(self):
            return self.getToken(Chomp_GameParser.ACTION, 0)

        def actionSymbol(self):
            return self.getTypedRuleContext(Chomp_GameParser.ActionSymbolContext,0)
        ...
        def PARAMETER(self):
            return self.getToken(Chomp_GameParser.PARAMETER, 0)
        ...
        def PRECONDITION(self):
            return self.getToken(Chomp_GameParser.PRECONDITION, 0)
        ...
        def EFFECT(self):
            return self.getToken(Chomp_GameParser.EFFECT, 0)

        def emptyOrEffect(self):
            return self.getTypedRuleContext(Chomp_GameParser.EmptyOrEffectContext,0)


        def getRuleIndex(self):
            return Chomp_GameParser.RULE_actionDefine
    ...
    def actionDefine(self):
        ...
        localctx = Chomp_GameParser.ActionDefineContext(self, self._ctx, self.state)
        ...
        try:
            ...
            self.match(Chomp_GameParser.COLON)
            self.state = 152
            self.match(Chomp_GameParser.ACTION)
            self.state = 153
            self.actionSymbol()
            self.state = 160
            self._errHandler.sync(self)
            ...
            if la_ == 1:
                ...
                self.match(Chomp_GameParser.COLON)
                self.state = 155
                self.match(Chomp_GameParser.PARAMETER)
                self.state = 156
                self.match(Chomp_GameParser.LB)
                self.state = 157
                self.listVariable()
            ...
            if la_ == 1:
                ...
                self.match(Chomp_GameParser.COLON)
                self.state = 163
                self.match(Chomp_GameParser.PRECONDITION)
                self.state = 164
                self.emptyOrPreGD()
            ...
            self._errHandler.sync(self)
            _la = self._input.LA(1)
            if _la==Chomp_GameParser.COLON:
                self.state = 167
                self.match(Chomp_GameParser.COLON)
                self.state = 168
                self.match(Chomp_GameParser.EFFECT)
                self.state = 169
                self.emptyOrEffect()
    ...
    class ActionSymbolContext(ParserRuleContext):
        ...
        def getRuleIndex(self):
            return Chomp_GameParser.RULE_actionSymbol
    ...
    def actionSymbol(self):
        ...
        localctx = Chomp_GameParser.ActionSymbolContext(self, self._ctx, self.state)
    ...
    class EmptyOrPreGDContext(ParserRuleContext):
        ...
        def gd(self):
            return self.getTypedRuleContext(Chomp_GameParser.GdContext,0)
        ...
        def getRuleIndex(self):
            return Chomp_GameParser.RULE_emptyOrPreGD
    ...
    def emptyOrPreGD(self):
        ...
        localctx = Chomp_GameParser.EmptyOrPreGDContext(self, self._ctx, self.state)
    ...
    class EmptyOrEffectContext(ParserRuleContext):
        ...
        def effect(self):
            return self.getTypedRuleContext(Chomp_GameParser.EffectContext,0)
        ...
        def getRuleIndex(self):
            return Chomp_GameParser.RULE_emptyOrEffect
    ...
    def emptyOrEffect(self):
        ...
        localctx = Chomp_GameParser.EmptyOrEffectContext(self, self._ctx, self.state)
    ...
    class ListNameContext(ParserRuleContext):
        ...
        def NAME(self, i:int=None):
            if i is None:
                return self.getTokens(Chomp_GameParser.NAME)
            else:
                return self.getToken(Chomp_GameParser.NAME, i)

        def MINUS(self):
            return self.getToken(Chomp_GameParser.MINUS, 0)

        def type(self):
            return self.getTypedRuleContext(Chomp_GameParser.TypeContext,0)


        def listName(self):
            return self.getTypedRuleContext(Chomp_GameParser.ListNameContext,0)


        def getRuleIndex(self):
            return Chomp_GameParser.RULE_listName
    ...
    def listName(self):
        ...
        localctx = Chomp_GameParser.ListNameContext(self, self._ctx, self.state)
        ...
        try:
            ...
            if la_ == 1:
                ...
                self._errHandler.sync(self)
                _la = self._input.LA(1)
                while _la==Chomp_GameParser.NAME:
                    self.state = 186
                    self.match(Chomp_GameParser.NAME)
                    self.state = 191
                    self._errHandler.sync(self)
                ...
                self.state = 197
                self.match(Chomp_GameParser.MINUS)
                self.state = 198
                self.type()
                self.state = 199
                self.listName()
    ...
    class ListVariableContext(ParserRuleContext):
        ...
        def VAR(self, i:int=None):
            if i is None:
                return self.getTokens(Chomp_GameParser.VAR)
            else:
                return self.getToken(Chomp_GameParser.VAR, i)
        ...
        def getRuleIndex(self):
            return Chomp_GameParser.RULE_listVariable
    ...
    def listVariable(self):
        ...
        localctx = Chomp_GameParser.ListVariableContext(self, self._ctx, self.state)
        ...
        try:
            ...
            if la_ == 1:
                ...
                self._errHandler.sync(self)
                _la = self._input.LA(1)
                while _la==Chomp_GameParser.VAR:
                    self.state = 203
                    self.match(Chomp_GameParser.VAR)
                    self.state = 208
                    self._errHandler.sync(self)
                    _la = self._input.LA(1)
                ...
                while True:
                    ...
                    self._errHandler.sync(self)
                    _la = self._input.LA(1)
                    if not (_la==Chomp_GameParser.VAR):
                        break
    ...
    class OneofDefineContext(ParserRuleContext):
        ...
        def ONEOF(self):
            return self.getToken(Chomp_GameParser.ONEOF, 0)
        ...
        def getRuleIndex(self):
            return Chomp_GameParser.RULE_oneofDefine
    ...
    def oneofDefine(self):
        ...
        localctx = Chomp_GameParser.OneofDefineContext(self, self._ctx, self.state)
        self.enterRule(localctx, 34, self.RULE_oneofDefine)
        self._la = 0 # Token type
        try:
            self.enterOuterAlt(localctx, 1)
            self.state = 220
            self.match(Chomp_GameParser.ONEOF)
            self.state = 222 
            self._errHandler.sync(self)
            _la = self._input.LA(1)
            while True:
    ...
    class GdContext(ParserRuleContext):
        ...
        def termAtomForm(self):
            return self.getTypedRuleContext(Chomp_GameParser.TermAtomFormContext,0)
        ...
        def AND(self):
            return self.getToken(Chomp_GameParser.AND, 0)
        ...
        def gd(self, i:int=None):
            if i is None:
                return self.getTypedRuleContexts(Chomp_GameParser.GdContext)
            else:
                return self.getTypedRuleContext(Chomp_GameParser.GdContext,i)


        def OR(self):
            return self.getToken(Chomp_GameParser.OR, 0)

        def NOT(self):
            return self.getToken(Chomp_GameParser.NOT, 0)

        def IMPLY(self):
            return self.getToken(Chomp_GameParser.IMPLY, 0)

        def EXISTS(self):
            return self.getToken(Chomp_GameParser.EXISTS, 0)
        ...
        def FORALL(self):
            return self.getToken(Chomp_GameParser.FORALL, 0)

        def getRuleIndex(self):
            return Chomp_GameParser.RULE_gd
    ...
    def gd(self):
        ...
        localctx = Chomp_GameParser.GdContext(self, self._ctx, self.state)
        ...
        try:
            ...
            if la_ == 1:
                ...
                self.match(Chomp_GameParser.LB)
                self.state = 228
                self.match(Chomp_GameParser.AND)
                self.state = 230 
                self._errHandler.sync(self)
                _la = self._input.LA(1)
                while True:
                ...
                self.match(Chomp_GameParser.LB)
                self.state = 237
                self.match(Chomp_GameParser.OR)
                self.state = 239 
                self._errHandler.sync(self)
                _la = self._input.LA(1)
                while True:
                ...
                self.match(Chomp_GameParser.LB)
                self.state = 246
                self.match(Chomp_GameParser.NOT)
                self.state = 247
                self.gd()
                self.state = 248
                self.match(Chomp_GameParser.RB)
                ...
                self.match(Chomp_GameParser.LB)
                self.state = 251
                self.match(Chomp_GameParser.IMPLY)
                self.state = 252
                self.gd()
                self.state = 253
                self.gd()
                ...
                self.match(Chomp_GameParser.LB)
                self.state = 257
                self.match(Chomp_GameParser.EXISTS)
                self.state = 258
                self.match(Chomp_GameParser.LB)
                self.state = 259
                self.listVariable()
                ...
                self.match(Chomp_GameParser.LB)
                self.state = 265
                self.match(Chomp_GameParser.FORALL)
                self.state = 266
                self.match(Chomp_GameParser.LB)
                self.state = 267
                self.listVariable()
    ...
    class TermAtomFormContext(ParserRuleContext):
        ...
        def term(self, i:int=None):
            if i is None:
                return self.getTypedRuleContexts(Chomp_GameParser.TermContext)
            else:
                return self.getTypedRuleContext(Chomp_GameParser.TermContext,i)


        def EQ(self):
            return self.getToken(Chomp_GameParser.EQ, 0)

        def NEQ(self):
            return self.getToken(Chomp_GameParser.NEQ, 0)

        def LT(self):
            return self.getToken(Chomp_GameParser.LT, 0)

        def LEQ(self):
            return self.getToken(Chomp_GameParser.LEQ, 0)

        def GT(self):
            return self.getToken(Chomp_GameParser.GT, 0)

        def GEQ(self):
            return self.getToken(Chomp_GameParser.GEQ, 0)

        def getRuleIndex(self):
            return Chomp_GameParser.RULE_termAtomForm
    ...
    def termAtomForm(self):
        ...
        localctx = Chomp_GameParser.TermAtomFormContext(self, self._ctx, self.state)
        ...
        try:
            ...
            if la_ == 1:
                ...
                self._errHandler.sync(self)
                _la = self._input.LA(1)
                while (((_la) & ~0x3f) == 0 and ((1 << _la) & ((1 << Chomp_GameParser.LB) | (1 << Chomp_GameParser.NAME) | (1 << Chomp_GameParser.INTEGER) | (1 << Chomp_GameParser.VAR))) != 0):
                    self.state = 276
                    self.term()
                    self.state = 281
                    self._errHandler.sync(self)
                ...
                self.match(Chomp_GameParser.LB)
                self.state = 285
                self.match(Chomp_GameParser.EQ)
                self.state = 286
                self.term()
                self.state = 287
                self.term()
                ...
                self.match(Chomp_GameParser.LB)
                self.state = 291
                self.match(Chomp_GameParser.NEQ)
                self.state = 292
                self.term()
                self.state = 293
                self.term()
                ...
                self.match(Chomp_GameParser.LB)
                self.state = 297
                self.match(Chomp_GameParser.LT)
                self.state = 298
                self.term()
                self.state = 299
                self.term()
                ...
                self.match(Chomp_GameParser.LB)
                self.state = 303
                self.match(Chomp_GameParser.LEQ)
                self.state = 304
                self.term()
                self.state = 305
                self.term()
                ...
                self.match(Chomp_GameParser.LB)
                self.state = 309
                self.match(Chomp_GameParser.GT)
                self.state = 310
                self.term()
                self.state = 311
                self.term()
                ...
                self.match(Chomp_GameParser.LB)
                self.state = 315
                self.match(Chomp_GameParser.GEQ)
                self.state = 316
                self.term()
                self.state = 317
                self.term()
    ...
    class TermLiteralContext(ParserRuleContext):
        ...
        def getRuleIndex(self):
            return Chomp_GameParser.RULE_termLiteral
    ...
    def termLiteral(self):
        ...
        localctx = Chomp_GameParser.TermLiteralContext(self, self._ctx, self.state)
    ...
    class ConstTermContext(ParserRuleContext):
        ...
        def INTEGER(self):
            return self.getToken(Chomp_GameParser.INTEGER, 0)
        ...
        def PLUS(self):
            return self.getToken(Chomp_GameParser.PLUS, 0)

        def getRuleIndex(self):
            return Chomp_GameParser.RULE_constTerm
    ...
    def constTerm(self):
        ...
        localctx = Chomp_GameParser.ConstTermContext(self, self._ctx, self.state)
        ...
        try:
            ...
            if la_ == 1:
                ...
                self.enterOuterAlt(localctx, 2)
                self.state = 331
                self.match(Chomp_GameParser.INTEGER)
                pass
                ...
                self.match(Chomp_GameParser.LB)
                self.state = 344
                self.match(Chomp_GameParser.PLUS)
                self.state = 345
                self.constTerm()
                self.state = 346
                self.constTerm()
    ...
    class TermContext(ParserRuleContext):
        ...
        def VAR(self):
            return self.getToken(Chomp_GameParser.VAR, 0)
        ...
        def getRuleIndex(self):
            return Chomp_GameParser.RULE_term
    ...
    def term(self):
        ...
        localctx = Chomp_GameParser.TermContext(self, self._ctx, self.state)
    ...
    class EffectContext(ParserRuleContext):
        ...
        def pEffect(self, i:int=None):
            if i is None:
                return self.getTypedRuleContexts(Chomp_GameParser.PEffectContext)
            else:
                return self.getTypedRuleContext(Chomp_GameParser.PEffectContext,i)


        def getRuleIndex(self):
            return Chomp_GameParser.RULE_effect
    ...
    def effect(self):
        ...
        localctx = Chomp_GameParser.EffectContext(self, self._ctx, self.state)
    ...
    class AssignopContext(ParserRuleContext):
        ...
        def INC(self):
            return self.getToken(Chomp_GameParser.INC, 0)

        def DEC(self):
            return self.getToken(Chomp_GameParser.DEC, 0)

        def ASSGIN(self):
            return self.getToken(Chomp_GameParser.ASSGIN, 0)

        def getRuleIndex(self):
            return Chomp_GameParser.RULE_assignop
    ...
    def assignop(self):
        ...
        localctx = Chomp_GameParser.AssignopContext(self, self._ctx, self.state)
        ...
        try:
            ...
            self.state = 385
            _la = self._input.LA(1)
            if not((((_la) & ~0x3f) == 0 and ((1 << _la) & ((1 << Chomp_GameParser.INC) | (1 << Chomp_GameParser.DEC) | (1 << Chomp_GameParser.ASSGIN))) != 0)):
                self._errHandler.recoverInline(self)
            else:
                self._errHandler.reportMatch(self)
                self.consume()
    ...
    class PEffectContext(ParserRuleContext):
        ...
        def assignop(self):
            return self.getTypedRuleContext(Chomp_GameParser.AssignopContext,0)
        ...
        def term(self):
            return self.getTypedRuleContext(Chomp_GameParser.TermContext,0)
        ...
        def getRuleIndex(self):
            return Chomp_GameParser.RULE_pEffect
    ...
    def pEffect(self):
        ...
        localctx = Chomp_GameParser.PEffectContext(self, self._ctx, self.state)
    ...
    class ProblemNameContext(ParserRuleContext):
        ...
        def getRuleIndex(self):
            return Chomp_GameParser.RULE_problemName
    ...
    def problemName(self):
        ...
        localctx = Chomp_GameParser.ProblemNameContext(self, self._ctx, self.state)
    ...
    class DomainNameContext(ParserRuleContext):
        ...
        def getRuleIndex(self):
            return Chomp_GameParser.RULE_domainName
    ...
    def domainName(self):
        ...
        localctx = Chomp_GameParser.DomainNameContext(self, self._ctx, self.state)
    ...
    class AgentDefineContext(ParserRuleContext):
        ...
        def getRuleIndex(self):
            return Chomp_GameParser.RULE_agentDefine
    ...
    def agentDefine(self):
        ...
        localctx = Chomp_GameParser.AgentDefineContext(self, self._ctx, self.state)
        ...
        try:
            ...
            self.match(Chomp_GameParser.COLON)
            self.state = 399
            self.match(Chomp_GameParser.AGENT)
            self.state = 401 
            self._errHandler.sync(self)
            _la = self._input.LA(1)
            while True:
    ...
    class ObjectDeclarationContext(ParserRuleContext):
        ...
        def getRuleIndex(self):
            return Chomp_GameParser.RULE_objectDeclaration
    ...
    def objectDeclaration(self):
        ...
        localctx = Chomp_GameParser.ObjectDeclarationContext(self, self._ctx, self.state)
    ...
    class NumericSettingContext(ParserRuleContext):
        ...
        def INTEGER(self, i:int=None):
            if i is None:
                return self.getTokens(Chomp_GameParser.INTEGER)
            else:
                return self.getToken(Chomp_GameParser.INTEGER, i)

        def getRuleIndex(self):
            return Chomp_GameParser.RULE_numericSetting
    ...
    def numericSetting(self):
        ...
        localctx = Chomp_GameParser.NumericSettingContext(self, self._ctx, self.state)
    ...
    class InitContext(ParserRuleContext):
        ...
        def INIT(self):
            return self.getToken(Chomp_GameParser.INIT, 0)
        ...
        def constTermAtomForm(self, i:int=None):
            if i is None:
                return self.getTypedRuleContexts(Chomp_GameParser.ConstTermAtomFormContext)
            else:
                return self.getTypedRuleContext(Chomp_GameParser.ConstTermAtomFormContext,i)


        def getRuleIndex(self):
            return Chomp_GameParser.RULE_init
    ...
    def init(self):
        ...
        localctx = Chomp_GameParser.InitContext(self, self._ctx, self.state)
        ...
        try:
            ...
            self.match(Chomp_GameParser.COLON)
            self.state = 429
            self.match(Chomp_GameParser.INIT)
            self.state = 433
            self._errHandler.sync(self)
            _la = self._input.LA(1)
            while _la==Chomp_GameParser.LB:
    ...
    class ConstTermAtomFormContext(ParserRuleContext):
        ...
        def getRuleIndex(self):
            return Chomp_GameParser.RULE_constTermAtomForm
    ...
    def constTermAtomForm(self):
        ...
        localctx = Chomp_GameParser.ConstTermAtomFormContext(self, self._ctx, self.state)
        ...
        try:
            ...
            if la_ == 1:
                ...
                self._errHandler.sync(self)
                _la = self._input.LA(1)
                while (((_la) & ~0x3f) == 0 and ((1 << _la) & ((1 << Chomp_GameParser.LB) | (1 << Chomp_GameParser.NAME) | (1 << Chomp_GameParser.INTEGER))) != 0):
                    self.state = 440
                    self.constTerm()
                    self.state = 445
                    self._errHandler.sync(self)
