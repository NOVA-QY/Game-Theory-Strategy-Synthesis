...
class Take_AwayParser ( Parser ):

    grammarFileName = "Take_Away.g4"
    ...
    class DomainContext(ParserRuleContext):
        ...
        def LB(self, i:int=None):
            if i is None:
                return self.getTokens(Take_AwayParser.LB)
            else:
                return self.getToken(Take_AwayParser.LB, i)

        def DEFINE(self):
            return self.getToken(Take_AwayParser.DEFINE, 0)

        def DOMAIN(self):
            return self.getToken(Take_AwayParser.DOMAIN, 0)

        def NAME(self):
            return self.getToken(Take_AwayParser.NAME, 0)

        def RB(self, i:int=None):
            if i is None:
                return self.getTokens(Take_AwayParser.RB)
            else:
                return self.getToken(Take_AwayParser.RB, i)

        def objectDefine(self):
            return self.getTypedRuleContext(Take_AwayParser.ObjectDefineContext,0)


        def typeDefine(self):
            return self.getTypedRuleContext(Take_AwayParser.TypeDefineContext,0)


        def terconditionDefine(self):
            return self.getTypedRuleContext(Take_AwayParser.TerconditionDefineContext,0)


        def actionDefine(self, i:int=None):
            if i is None:
                return self.getTypedRuleContexts(Take_AwayParser.ActionDefineContext)
            else:
                return self.getTypedRuleContext(Take_AwayParser.ActionDefineContext,i)


        def getRuleIndex(self):
            return Take_AwayParser.RULE_domain
    ...
    def domain(self):
        ...
        localctx = Take_AwayParser.DomainContext(self, self._ctx, self.state)
        self.enterRule(localctx, 0, self.RULE_domain)
        self._la = 0 # Token type
        try:
            self.enterOuterAlt(localctx, 1)
            self.state = 66
            self.match(Take_AwayParser.LB)
            self.state = 67
            self.match(Take_AwayParser.DEFINE)
            self.state = 68
            self.match(Take_AwayParser.LB)
            self.state = 69
            self.match(Take_AwayParser.DOMAIN)
            self.state = 70
            self.match(Take_AwayParser.NAME)
            self.state = 71
            self.match(Take_AwayParser.RB)
            self.state = 72
            self.objectDefine()
            self.state = 73
            self.typeDefine()
    ...
    class ObjectDefineContext(ParserRuleContext):
        ...
        def LB(self):
            return self.getToken(Take_AwayParser.LB, 0)

        def COLON(self):
            return self.getToken(Take_AwayParser.COLON, 0)

        def OBJS(self):
            return self.getToken(Take_AwayParser.OBJS, 0)

        def listVariable(self):
            return self.getTypedRuleContext(Take_AwayParser.ListVariableContext,0)


        def RB(self):
            return self.getToken(Take_AwayParser.RB, 0)

        def getRuleIndex(self):
            return Take_AwayParser.RULE_objectDefine
    ...
    def objectDefine(self):
        ...
        localctx = Take_AwayParser.ObjectDefineContext(self, self._ctx, self.state)
        ...
        try:
            ...
            self.match(Take_AwayParser.LB)
            self.state = 84
            self.match(Take_AwayParser.COLON)
            self.state = 85
            self.match(Take_AwayParser.OBJS)
            self.state = 86
            self.listVariable()
            self.state = 87
            self.match(Take_AwayParser.RB)
    ...
    class NumericDefineContext(ParserRuleContext):
        ...
        def NUMS(self):
            return self.getToken(Take_AwayParser.NUMS, 0)
        ...
        def numericSymbol(self, i:int=None):
            if i is None:
                return self.getTypedRuleContexts(Take_AwayParser.NumericSymbolContext)
            else:
                return self.getTypedRuleContext(Take_AwayParser.NumericSymbolContext,i)


        def getRuleIndex(self):
            return Take_AwayParser.RULE_numericDefine
    ...
    def numericDefine(self):
        ...
        localctx = Take_AwayParser.NumericDefineContext(self, self._ctx, self.state)
        ...
        try:
            ...
            self.match(Take_AwayParser.COLON)
            self.state = 91
            self.match(Take_AwayParser.NUMS)
            self.state = 93 
            self._errHandler.sync(self)
            _la = self._input.LA(1)
            while True:
                ...
                self._errHandler.sync(self)
                _la = self._input.LA(1)
                if not (_la==Take_AwayParser.NAME):
                    break
    ...
    class NumericSymbolContext(ParserRuleContext):
        ...
        def getRuleIndex(self):
            return Take_AwayParser.RULE_numericSymbol
    ...
    def numericSymbol(self):
        ...
        localctx = Take_AwayParser.NumericSymbolContext(self, self._ctx, self.state)
    ...
    class TypeDefineContext(ParserRuleContext):
        ...
        def TYPE(self):
            return self.getToken(Take_AwayParser.TYPE, 0)

        def NORMAL(self):
            return self.getToken(Take_AwayParser.NORMAL, 0)

        def RB(self):
            return self.getToken(Take_AwayParser.RB, 0)

        def MISER(self):
            return self.getToken(Take_AwayParser.MISER, 0)

        def getRuleIndex(self):
            return Take_AwayParser.RULE_typeDefine
    ...
    def typeDefine(self):
        ...
        localctx = Take_AwayParser.TypeDefineContext(self, self._ctx, self.state)
        ...
        try:
            ...
            if la_ == 1:
                ...
                self.match(Take_AwayParser.COLON)
                self.state = 103
                self.match(Take_AwayParser.TYPE)
                self.state = 104
                self.match(Take_AwayParser.NORMAL)
                self.state = 105
                self.match(Take_AwayParser.RB)
                pass
                ...
                self.match(Take_AwayParser.TYPE)
                self.state = 109
                self.match(Take_AwayParser.MISER)
                self.state = 110
                self.match(Take_AwayParser.RB)
                pass
    ...
    class TerconditionDefineContext(ParserRuleContext):
        ...
        def TERCONDITION(self):
            return self.getToken(Take_AwayParser.TERCONDITION, 0)

        def emptyOrPreGD(self):
            return self.getTypedRuleContext(Take_AwayParser.EmptyOrPreGDContext,0)
        ...
        def getRuleIndex(self):
            return Take_AwayParser.RULE_terconditionDefine
    ...
    def terconditionDefine(self):
        ...
        localctx = Take_AwayParser.TerconditionDefineContext(self, self._ctx, self.state)
        ...
        try:
            ...
            self.match(Take_AwayParser.COLON)
            self.state = 115
            self.match(Take_AwayParser.TERCONDITION)
            self.state = 116
            self.emptyOrPreGD()
            self.state = 117
            self.match(Take_AwayParser.RB)
    ...
    class PredicateDefineContext(ParserRuleContext):
        ...
        def PREDICATE(self):
            return self.getToken(Take_AwayParser.PREDICATE, 0)
        ...
        def atomFormSkeleton(self, i:int=None):
            if i is None:
                return self.getTypedRuleContexts(Take_AwayParser.AtomFormSkeletonContext)
            else:
                return self.getTypedRuleContext(Take_AwayParser.AtomFormSkeletonContext,i)


        def getRuleIndex(self):
            return Take_AwayParser.RULE_predicateDefine
    ...
    def predicateDefine(self):
        ...
        localctx = Take_AwayParser.PredicateDefineContext(self, self._ctx, self.state)
        ...
        try:
            ...
            self.match(Take_AwayParser.COLON)
            self.state = 121
            self.match(Take_AwayParser.PREDICATE)
            self.state = 123 
            self._errHandler.sync(self)
            _la = self._input.LA(1)
            while True:
    ...
    class AtomFormSkeletonContext(ParserRuleContext):
        ...
        def predicate(self):
            return self.getTypedRuleContext(Take_AwayParser.PredicateContext,0)
        ...
        def oneofDefine(self):
            return self.getTypedRuleContext(Take_AwayParser.OneofDefineContext,0)


        def getRuleIndex(self):
            return Take_AwayParser.RULE_atomFormSkeleton
    ...
    def atomFormSkeleton(self):
        ...
        localctx = Take_AwayParser.AtomFormSkeletonContext(self, self._ctx, self.state)
    ...
    class PredicateContext(ParserRuleContext):
        ...
        def getRuleIndex(self):
            return Take_AwayParser.RULE_predicate
    ...
    def predicate(self):
        ...
        localctx = Take_AwayParser.PredicateContext(self, self._ctx, self.state)
    ...
    class TypeDeclarationContext(ParserRuleContext):
        ...
        def constTerm(self, i:int=None):
            if i is None:
                return self.getTypedRuleContexts(Take_AwayParser.ConstTermContext)
            else:
                return self.getTypedRuleContext(Take_AwayParser.ConstTermContext,i)
        ...
        def getRuleIndex(self):
            return Take_AwayParser.RULE_typeDeclaration
    ...
    def typeDeclaration(self):
        ...
        localctx = Take_AwayParser.TypeDeclarationContext(self, self._ctx, self.state)
        self.enterRule(localctx, 18, self.RULE_typeDeclaration)
        try:
            self.state = 146
            self._errHandler.sync(self)
            token = self._input.LA(1)
            if token in [Take_AwayParser.NAME]:
                self.enterOuterAlt(localctx, 1)
                self.state = 139
                self.match(Take_AwayParser.NAME)
                pass
            elif token in [Take_AwayParser.LB]:
                self.enterOuterAlt(localctx, 2)
                self.state = 140
                self.match(Take_AwayParser.LB)
                self.state = 141
    ...
    class TypeContext(ParserRuleContext):
        ...
        def OBJECT(self):
            return self.getToken(Take_AwayParser.OBJECT, 0)

        def AGENT(self):
            return self.getToken(Take_AwayParser.AGENT, 0)

        def NAME(self):
            return self.getToken(Take_AwayParser.NAME, 0)

        def getRuleIndex(self):
            return Take_AwayParser.RULE_type
    ...
    def type(self):
        ...
        localctx = Take_AwayParser.TypeContext(self, self._ctx, self.state)
        ...
        try:
            ...
            self.state = 148
            _la = self._input.LA(1)
            if not((((_la) & ~0x3f) == 0 and ((1 << _la) & ((1 << Take_AwayParser.OBJECT) | (1 << Take_AwayParser.AGENT) | (1 << Take_AwayParser.NAME))) != 0)):
    ...
    class ActionDefineContext(ParserRuleContext):
        ...
        def COLON(self, i:int=None):
            if i is None:
                return self.getTokens(Take_AwayParser.COLON)
            else:
                return self.getToken(Take_AwayParser.COLON, i)

        def ACTION(self):
            return self.getToken(Take_AwayParser.ACTION, 0)

        def actionSymbol(self):
            return self.getTypedRuleContext(Take_AwayParser.ActionSymbolContext,0)
        ...
        def PARAMETER(self):
            return self.getToken(Take_AwayParser.PARAMETER, 0)
        ...
        def PRECONDITION(self):
            return self.getToken(Take_AwayParser.PRECONDITION, 0)
        ...
        def EFFECT(self):
            return self.getToken(Take_AwayParser.EFFECT, 0)

        def emptyOrEffect(self):
            return self.getTypedRuleContext(Take_AwayParser.EmptyOrEffectContext,0)


        def getRuleIndex(self):
            return Take_AwayParser.RULE_actionDefine
    ...
    def actionDefine(self):
        ...
        localctx = Take_AwayParser.ActionDefineContext(self, self._ctx, self.state)
        ...
        try:
            ...
            self.match(Take_AwayParser.COLON)
            self.state = 152
            self.match(Take_AwayParser.ACTION)
            self.state = 153
            self.actionSymbol()
            self.state = 160
            self._errHandler.sync(self)
            ...
            if la_ == 1:
                ...
                self.match(Take_AwayParser.COLON)
                self.state = 155
                self.match(Take_AwayParser.PARAMETER)
                self.state = 156
                self.match(Take_AwayParser.LB)
                self.state = 157
                self.listVariable()
            ...
            if la_ == 1:
                ...
                self.match(Take_AwayParser.COLON)
                self.state = 163
                self.match(Take_AwayParser.PRECONDITION)
                self.state = 164
                self.emptyOrPreGD()
            ...
            self._errHandler.sync(self)
            _la = self._input.LA(1)
            if _la==Take_AwayParser.COLON:
                self.state = 167
                self.match(Take_AwayParser.COLON)
                self.state = 168
                self.match(Take_AwayParser.EFFECT)
                self.state = 169
                self.emptyOrEffect()
    ...
    class ActionSymbolContext(ParserRuleContext):
        ...
        def getRuleIndex(self):
            return Take_AwayParser.RULE_actionSymbol
    ...
    def actionSymbol(self):
        ...
        localctx = Take_AwayParser.ActionSymbolContext(self, self._ctx, self.state)
    ...
    class EmptyOrPreGDContext(ParserRuleContext):
        ...
        def gd(self):
            return self.getTypedRuleContext(Take_AwayParser.GdContext,0)
        ...
        def getRuleIndex(self):
            return Take_AwayParser.RULE_emptyOrPreGD
    ...
    def emptyOrPreGD(self):
        ...
        localctx = Take_AwayParser.EmptyOrPreGDContext(self, self._ctx, self.state)
    ...
    class EmptyOrEffectContext(ParserRuleContext):
        ...
        def effect(self):
            return self.getTypedRuleContext(Take_AwayParser.EffectContext,0)
        ...
        def getRuleIndex(self):
            return Take_AwayParser.RULE_emptyOrEffect
    ...
    def emptyOrEffect(self):
        ...
        localctx = Take_AwayParser.EmptyOrEffectContext(self, self._ctx, self.state)
    ...
    class ListNameContext(ParserRuleContext):
        ...
        def NAME(self, i:int=None):
            if i is None:
                return self.getTokens(Take_AwayParser.NAME)
            else:
                return self.getToken(Take_AwayParser.NAME, i)

        def MINUS(self):
            return self.getToken(Take_AwayParser.MINUS, 0)

        def type(self):
            return self.getTypedRuleContext(Take_AwayParser.TypeContext,0)


        def listName(self):
            return self.getTypedRuleContext(Take_AwayParser.ListNameContext,0)


        def getRuleIndex(self):
            return Take_AwayParser.RULE_listName
    ...
    def listName(self):
        ...
        localctx = Take_AwayParser.ListNameContext(self, self._ctx, self.state)
        ...
        try:
            ...
            if la_ == 1:
                ...
                self._errHandler.sync(self)
                _la = self._input.LA(1)
                while _la==Take_AwayParser.NAME:
                    self.state = 186
                    self.match(Take_AwayParser.NAME)
                    self.state = 191
                    self._errHandler.sync(self)
                ...
                self.state = 197
                self.match(Take_AwayParser.MINUS)
                self.state = 198
                self.type()
                self.state = 199
                self.listName()
    ...
    class ListVariableContext(ParserRuleContext):
        ...
        def VAR(self, i:int=None):
            if i is None:
                return self.getTokens(Take_AwayParser.VAR)
            else:
                return self.getToken(Take_AwayParser.VAR, i)
        ...
        def getRuleIndex(self):
            return Take_AwayParser.RULE_listVariable
    ...
    def listVariable(self):
        ...
        localctx = Take_AwayParser.ListVariableContext(self, self._ctx, self.state)
        ...
        try:
            ...
            if la_ == 1:
                ...
                self._errHandler.sync(self)
                _la = self._input.LA(1)
                while _la==Take_AwayParser.VAR:
                    self.state = 203
                    self.match(Take_AwayParser.VAR)
                    self.state = 208
                    self._errHandler.sync(self)
                    _la = self._input.LA(1)
                ...
                while True:
                    ...
                    self._errHandler.sync(self)
                    _la = self._input.LA(1)
                    if not (_la==Take_AwayParser.VAR):
                        break
    ...
    class OneofDefineContext(ParserRuleContext):
        ...
        def ONEOF(self):
            return self.getToken(Take_AwayParser.ONEOF, 0)
        ...
        def getRuleIndex(self):
            return Take_AwayParser.RULE_oneofDefine
    ...
    def oneofDefine(self):
        ...
        localctx = Take_AwayParser.OneofDefineContext(self, self._ctx, self.state)
        self.enterRule(localctx, 34, self.RULE_oneofDefine)
        self._la = 0 # Token type
        try:
            self.enterOuterAlt(localctx, 1)
            self.state = 220
            self.match(Take_AwayParser.ONEOF)
            self.state = 222 
            self._errHandler.sync(self)
            _la = self._input.LA(1)
            while True:
    ...
    class GdContext(ParserRuleContext):
        ...
        def termAtomForm(self):
            return self.getTypedRuleContext(Take_AwayParser.TermAtomFormContext,0)
        ...
        def AND(self):
            return self.getToken(Take_AwayParser.AND, 0)
        ...
        def gd(self, i:int=None):
            if i is None:
                return self.getTypedRuleContexts(Take_AwayParser.GdContext)
            else:
                return self.getTypedRuleContext(Take_AwayParser.GdContext,i)


        def OR(self):
            return self.getToken(Take_AwayParser.OR, 0)

        def NOT(self):
            return self.getToken(Take_AwayParser.NOT, 0)

        def IMPLY(self):
            return self.getToken(Take_AwayParser.IMPLY, 0)

        def EXISTS(self):
            return self.getToken(Take_AwayParser.EXISTS, 0)
        ...
        def FORALL(self):
            return self.getToken(Take_AwayParser.FORALL, 0)

        def getRuleIndex(self):
            return Take_AwayParser.RULE_gd
    ...
    def gd(self):
        ...
        localctx = Take_AwayParser.GdContext(self, self._ctx, self.state)
        ...
        try:
            ...
            if la_ == 1:
                ...
                self.match(Take_AwayParser.LB)
                self.state = 228
                self.match(Take_AwayParser.AND)
                self.state = 230 
                self._errHandler.sync(self)
                _la = self._input.LA(1)
                while True:
                ...
                self.match(Take_AwayParser.LB)
                self.state = 246
                self.match(Take_AwayParser.NOT)
                self.state = 247
                self.gd()
                self.state = 248
                self.match(Take_AwayParser.RB)
                ...
                self.match(Take_AwayParser.LB)
                self.state = 251
                self.match(Take_AwayParser.IMPLY)
                self.state = 252
                self.gd()
                self.state = 253
                self.gd()
                ...
                self.match(Take_AwayParser.LB)
                self.state = 257
                self.match(Take_AwayParser.EXISTS)
                self.state = 258
                self.match(Take_AwayParser.LB)
                self.state = 259
                self.listVariable()
                ...
                self.match(Take_AwayParser.LB)
                self.state = 265
                self.match(Take_AwayParser.FORALL)
                self.state = 266
                self.match(Take_AwayParser.LB)
                self.state = 267
                self.listVariable()
    ...
    class TermAtomFormContext(ParserRuleContext):
        ...
        def term(self, i:int=None):
            if i is None:
                return self.getTypedRuleContexts(Take_AwayParser.TermContext)
            else:
                return self.getTypedRuleContext(Take_AwayParser.TermContext,i)


        def EQ(self):
            return self.getToken(Take_AwayParser.EQ, 0)

        def NEQ(self):
            return self.getToken(Take_AwayParser.NEQ, 0)

        def LT(self):
            return self.getToken(Take_AwayParser.LT, 0)

        def LEQ(self):
            return self.getToken(Take_AwayParser.LEQ, 0)

        def GT(self):
            return self.getToken(Take_AwayParser.GT, 0)

        def GEQ(self):
            return self.getToken(Take_AwayParser.GEQ, 0)

        def getRuleIndex(self):
            return Take_AwayParser.RULE_termAtomForm
    ...
    def termAtomForm(self):
        ...
        localctx = Take_AwayParser.TermAtomFormContext(self, self._ctx, self.state)
        ...
        try:
            ...
            if la_ == 1:
                ...
                self._errHandler.sync(self)
                _la = self._input.LA(1)
                while (((_la) & ~0x3f) == 0 and ((1 << _la) & ((1 << Take_AwayParser.LB) | (1 << Take_AwayParser.NAME) | (1 << Take_AwayParser.INTEGER) | (1 << Take_AwayParser.VAR))) != 0):
                    self.state = 276
                    self.term()
                    self.state = 281
                    self._errHandler.sync(self)
                ...
                self.match(Take_AwayParser.LB)
                self.state = 291
                self.match(Take_AwayParser.NEQ)
                self.state = 292
                self.term()
                self.state = 293
                self.term()
                ...
                self.match(Take_AwayParser.LB)
                self.state = 303
                self.match(Take_AwayParser.LEQ)
                self.state = 304
                self.term()
                self.state = 305
                self.term()
                ...
                self.match(Take_AwayParser.LB)
                self.state = 315
                self.match(Take_AwayParser.GEQ)
                self.state = 316
                self.term()
                self.state = 317
                self.term()
    ...
    class TermLiteralContext(ParserRuleContext):
        ...
        def getRuleIndex(self):
            return Take_AwayParser.RULE_termLiteral
    ...
    def termLiteral(self):
        ...
        localctx = Take_AwayParser.TermLiteralContext(self, self._ctx, self.state)
    ...
    class ConstTermContext(ParserRuleContext):
        ...
        def INTEGER(self):
            return self.getToken(Take_AwayParser.INTEGER, 0)
        ...
        def PLUS(self):
            return self.getToken(Take_AwayParser.PLUS, 0)

        def getRuleIndex(self):
            return Take_AwayParser.RULE_constTerm
    ...
    def constTerm(self):
        ...
        localctx = Take_AwayParser.ConstTermContext(self, self._ctx, self.state)
        ...
        try:
            ...
            if la_ == 1:
                ...
                self.enterOuterAlt(localctx, 2)
                self.state = 331
                self.match(Take_AwayParser.INTEGER)
                pass
                ...
                self.match(Take_AwayParser.LB)
                self.state = 344
                self.match(Take_AwayParser.PLUS)
                self.state = 345
                self.constTerm()
                self.state = 346
                self.constTerm()
    ...
    class TermContext(ParserRuleContext):
        ...
        def VAR(self):
            return self.getToken(Take_AwayParser.VAR, 0)
        ...
        def getRuleIndex(self):
            return Take_AwayParser.RULE_term
    ...
    def term(self):
        ...
        localctx = Take_AwayParser.TermContext(self, self._ctx, self.state)
    ...
    class EffectContext(ParserRuleContext):
        ...
        def pEffect(self, i:int=None):
            if i is None:
                return self.getTypedRuleContexts(Take_AwayParser.PEffectContext)
            else:
                return self.getTypedRuleContext(Take_AwayParser.PEffectContext,i)


        def getRuleIndex(self):
            return Take_AwayParser.RULE_effect
    ...
    def effect(self):
        ...
        localctx = Take_AwayParser.EffectContext(self, self._ctx, self.state)
    ...
    class AssignopContext(ParserRuleContext):
        ...
        def INC(self):
            return self.getToken(Take_AwayParser.INC, 0)

        def DEC(self):
            return self.getToken(Take_AwayParser.DEC, 0)

        def ASSGIN(self):
            return self.getToken(Take_AwayParser.ASSGIN, 0)

        def getRuleIndex(self):
            return Take_AwayParser.RULE_assignop
    ...
    def assignop(self):
        ...
        localctx = Take_AwayParser.AssignopContext(self, self._ctx, self.state)
        ...
        try:
            ...
            self.state = 385
            _la = self._input.LA(1)
            if not((((_la) & ~0x3f) == 0 and ((1 << _la) & ((1 << Take_AwayParser.INC) | (1 << Take_AwayParser.DEC) | (1 << Take_AwayParser.ASSGIN))) != 0)):
                self._errHandler.recoverInline(self)
            else:
                self._errHandler.reportMatch(self)
                self.consume()
    ...
    class PEffectContext(ParserRuleContext):
        ...
        def assignop(self):
            return self.getTypedRuleContext(Take_AwayParser.AssignopContext,0)
        ...
        def term(self):
            return self.getTypedRuleContext(Take_AwayParser.TermContext,0)
        ...
        def getRuleIndex(self):
            return Take_AwayParser.RULE_pEffect
    ...
    def pEffect(self):
        ...
        localctx = Take_AwayParser.PEffectContext(self, self._ctx, self.state)
    ...
    class ProblemNameContext(ParserRuleContext):
        ...
        def getRuleIndex(self):
            return Take_AwayParser.RULE_problemName
    ...
    def problemName(self):
        ...
        localctx = Take_AwayParser.ProblemNameContext(self, self._ctx, self.state)
    ...
    class DomainNameContext(ParserRuleContext):
        ...
        def getRuleIndex(self):
            return Take_AwayParser.RULE_domainName
    ...
    def domainName(self):
        ...
        localctx = Take_AwayParser.DomainNameContext(self, self._ctx, self.state)
    ...
    class AgentDefineContext(ParserRuleContext):
        ...
        def getRuleIndex(self):
            return Take_AwayParser.RULE_agentDefine
    ...
    def agentDefine(self):
        ...
        localctx = Take_AwayParser.AgentDefineContext(self, self._ctx, self.state)
        ...
        try:
            ...
            self.match(Take_AwayParser.COLON)
            self.state = 399
            self.match(Take_AwayParser.AGENT)
            self.state = 401 
            self._errHandler.sync(self)
            _la = self._input.LA(1)
            while True:
    ...
    class ObjectDeclarationContext(ParserRuleContext):
        ...
        def getRuleIndex(self):
            return Take_AwayParser.RULE_objectDeclaration
    ...
    def objectDeclaration(self):
        ...
        localctx = Take_AwayParser.ObjectDeclarationContext(self, self._ctx, self.state)
    ...
    class NumericSettingContext(ParserRuleContext):
        ...
        def INTEGER(self, i:int=None):
            if i is None:
                return self.getTokens(Take_AwayParser.INTEGER)
            else:
                return self.getToken(Take_AwayParser.INTEGER, i)

        def getRuleIndex(self):
            return Take_AwayParser.RULE_numericSetting
    ...
    def numericSetting(self):
        ...
        localctx = Take_AwayParser.NumericSettingContext(self, self._ctx, self.state)
    ...
    class InitContext(ParserRuleContext):
        ...
        def INIT(self):
            return self.getToken(Take_AwayParser.INIT, 0)
        ...
        def constTermAtomForm(self, i:int=None):
            if i is None:
                return self.getTypedRuleContexts(Take_AwayParser.ConstTermAtomFormContext)
            else:
                return self.getTypedRuleContext(Take_AwayParser.ConstTermAtomFormContext,i)


        def getRuleIndex(self):
            return Take_AwayParser.RULE_init
    ...
    def init(self):
        ...
        localctx = Take_AwayParser.InitContext(self, self._ctx, self.state)
        ...
        try:
            ...
            self.match(Take_AwayParser.COLON)
            self.state = 429
            self.match(Take_AwayParser.INIT)
            self.state = 433
            self._errHandler.sync(self)
            _la = self._input.LA(1)
            while _la==Take_AwayParser.LB:
    ...
    class ConstTermAtomFormContext(ParserRuleContext):
        ...
        def getRuleIndex(self):
            return Take_AwayParser.RULE_constTermAtomForm
    ...
    def constTermAtomForm(self):
        ...
        localctx = Take_AwayParser.ConstTermAtomFormContext(self, self._ctx, self.state)
        ...
        try:
            ...
            if la_ == 1:
                ...
                self._errHandler.sync(self)
                _la = self._input.LA(1)
                while (((_la) & ~0x3f) == 0 and ((1 << _la) & ((1 << Take_AwayParser.LB) | (1 << Take_AwayParser.NAME) | (1 << Take_AwayParser.INTEGER))) != 0):
                    self.state = 440
                    self.constTerm()
                    self.state = 445
                    self._errHandler.sync(self)
