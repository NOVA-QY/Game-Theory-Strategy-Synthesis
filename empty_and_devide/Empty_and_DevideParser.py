...
class Empty_and_DevideParser ( Parser ):

    grammarFileName = "Empty_and_Devide.g4"
    ...
    class DomainContext(ParserRuleContext):
        ...
        def LB(self, i:int=None):
            if i is None:
                return self.getTokens(Empty_and_DevideParser.LB)
            else:
                return self.getToken(Empty_and_DevideParser.LB, i)

        def DEFINE(self):
            return self.getToken(Empty_and_DevideParser.DEFINE, 0)

        def DOMAIN(self):
            return self.getToken(Empty_and_DevideParser.DOMAIN, 0)

        def NAME(self):
            return self.getToken(Empty_and_DevideParser.NAME, 0)

        def RB(self, i:int=None):
            if i is None:
                return self.getTokens(Empty_and_DevideParser.RB)
            else:
                return self.getToken(Empty_and_DevideParser.RB, i)

        def objectDefine(self):
            return self.getTypedRuleContext(Empty_and_DevideParser.ObjectDefineContext,0)


        def typeDefine(self):
            return self.getTypedRuleContext(Empty_and_DevideParser.TypeDefineContext,0)


        def terconditionDefine(self):
            return self.getTypedRuleContext(Empty_and_DevideParser.TerconditionDefineContext,0)


        def actionDefine(self, i:int=None):
            if i is None:
                return self.getTypedRuleContexts(Empty_and_DevideParser.ActionDefineContext)
            else:
                return self.getTypedRuleContext(Empty_and_DevideParser.ActionDefineContext,i)


        def getRuleIndex(self):
            return Empty_and_DevideParser.RULE_domain
    ...
    def domain(self):
        ...
        localctx = Empty_and_DevideParser.DomainContext(self, self._ctx, self.state)
        self.enterRule(localctx, 0, self.RULE_domain)
        self._la = 0 # Token type
        try:
            self.enterOuterAlt(localctx, 1)
            self.state = 66
            self.match(Empty_and_DevideParser.LB)
            self.state = 67
            self.match(Empty_and_DevideParser.DEFINE)
            self.state = 68
            self.match(Empty_and_DevideParser.LB)
            self.state = 69
            self.match(Empty_and_DevideParser.DOMAIN)
            self.state = 70
            self.match(Empty_and_DevideParser.NAME)
            self.state = 71
            self.match(Empty_and_DevideParser.RB)
            self.state = 72
            self.objectDefine()
            self.state = 73
            self.typeDefine()
            ...
            while _la==Empty_and_DevideParser.LB:
                self.state = 75
                self.actionDefine()
                self.state = 80
                self._errHandler.sync(self)
    ...
    class ObjectDefineContext(ParserRuleContext):
        ...
        def LB(self):
            return self.getToken(Empty_and_DevideParser.LB, 0)

        def COLON(self):
            return self.getToken(Empty_and_DevideParser.COLON, 0)

        def OBJS(self):
            return self.getToken(Empty_and_DevideParser.OBJS, 0)

        def listVariable(self):
            return self.getTypedRuleContext(Empty_and_DevideParser.ListVariableContext,0)


        def RB(self):
            return self.getToken(Empty_and_DevideParser.RB, 0)

        def getRuleIndex(self):
            return Empty_and_DevideParser.RULE_objectDefine
    ...
    def objectDefine(self):
        ...
        localctx = Empty_and_DevideParser.ObjectDefineContext(self, self._ctx, self.state)
        ...
        try:
            ...
            self.match(Empty_and_DevideParser.LB)
            self.state = 84
            self.match(Empty_and_DevideParser.COLON)
            self.state = 85
            self.match(Empty_and_DevideParser.OBJS)
            self.state = 86
            self.listVariable()
            self.state = 87
            self.match(Empty_and_DevideParser.RB)
    ...
    class NumericDefineContext(ParserRuleContext):
        ...
        def NUMS(self):
            return self.getToken(Empty_and_DevideParser.NUMS, 0)
        ...
        def numericSymbol(self, i:int=None):
            if i is None:
                return self.getTypedRuleContexts(Empty_and_DevideParser.NumericSymbolContext)
            else:
                return self.getTypedRuleContext(Empty_and_DevideParser.NumericSymbolContext,i)


        def getRuleIndex(self):
            return Empty_and_DevideParser.RULE_numericDefine
    ...
    def numericDefine(self):
        ...
        localctx = Empty_and_DevideParser.NumericDefineContext(self, self._ctx, self.state)
        ...
        try:
            ...
            self.match(Empty_and_DevideParser.COLON)
            self.state = 91
            self.match(Empty_and_DevideParser.NUMS)
            self.state = 93 
            self._errHandler.sync(self)
            _la = self._input.LA(1)
            while True:
                ...
                self._errHandler.sync(self)
                _la = self._input.LA(1)
                if not (_la==Empty_and_DevideParser.NAME):
                    break
    ...
    class NumericSymbolContext(ParserRuleContext):
        ...
        def getRuleIndex(self):
            return Empty_and_DevideParser.RULE_numericSymbol
    ...
    def numericSymbol(self):
        ...
        localctx = Empty_and_DevideParser.NumericSymbolContext(self, self._ctx, self.state)
    ...
    class TypeDefineContext(ParserRuleContext):
        ...
        def TYPE(self):
            return self.getToken(Empty_and_DevideParser.TYPE, 0)

        def NORMAL(self):
            return self.getToken(Empty_and_DevideParser.NORMAL, 0)

        def RB(self):
            return self.getToken(Empty_and_DevideParser.RB, 0)

        def MISER(self):
            return self.getToken(Empty_and_DevideParser.MISER, 0)

        def getRuleIndex(self):
            return Empty_and_DevideParser.RULE_typeDefine
    ...
    def typeDefine(self):
        ...
        localctx = Empty_and_DevideParser.TypeDefineContext(self, self._ctx, self.state)
        ...
        try:
            ...
            if la_ == 1:
                ...
                self.match(Empty_and_DevideParser.COLON)
                self.state = 103
                self.match(Empty_and_DevideParser.TYPE)
                self.state = 104
                self.match(Empty_and_DevideParser.NORMAL)
                self.state = 105
                self.match(Empty_and_DevideParser.RB)
                pass
                ...
                self.match(Empty_and_DevideParser.TYPE)
                self.state = 109
                self.match(Empty_and_DevideParser.MISER)
                self.state = 110
                self.match(Empty_and_DevideParser.RB)
                pass
    ...
    class TerconditionDefineContext(ParserRuleContext):
        ...
        def TERCONDITION(self):
            return self.getToken(Empty_and_DevideParser.TERCONDITION, 0)

        def emptyOrPreGD(self):
            return self.getTypedRuleContext(Empty_and_DevideParser.EmptyOrPreGDContext,0)
        ...
        def getRuleIndex(self):
            return Empty_and_DevideParser.RULE_terconditionDefine
    ...
    def terconditionDefine(self):
        ...
        localctx = Empty_and_DevideParser.TerconditionDefineContext(self, self._ctx, self.state)
        ...
        try:
            ...
            self.match(Empty_and_DevideParser.COLON)
            self.state = 115
            self.match(Empty_and_DevideParser.TERCONDITION)
            self.state = 116
            self.emptyOrPreGD()
            self.state = 117
            self.match(Empty_and_DevideParser.RB)
    ...
    class PredicateDefineContext(ParserRuleContext):
        ...
        def PREDICATE(self):
            return self.getToken(Empty_and_DevideParser.PREDICATE, 0)
        ...
        def atomFormSkeleton(self, i:int=None):
            if i is None:
                return self.getTypedRuleContexts(Empty_and_DevideParser.AtomFormSkeletonContext)
            else:
                return self.getTypedRuleContext(Empty_and_DevideParser.AtomFormSkeletonContext,i)


        def getRuleIndex(self):
            return Empty_and_DevideParser.RULE_predicateDefine
    ...
    def predicateDefine(self):
        ...
        localctx = Empty_and_DevideParser.PredicateDefineContext(self, self._ctx, self.state)
        ...
        try:
            ...
            self.match(Empty_and_DevideParser.COLON)
            self.state = 121
            self.match(Empty_and_DevideParser.PREDICATE)
            self.state = 123 
            self._errHandler.sync(self)
            _la = self._input.LA(1)
            while True:
                ...
                self._errHandler.sync(self)
                _la = self._input.LA(1)
                if not (_la==Empty_and_DevideParser.LB):
                    break
    ...
    class AtomFormSkeletonContext(ParserRuleContext):
        ...
        def predicate(self):
            return self.getTypedRuleContext(Empty_and_DevideParser.PredicateContext,0)
        ...
        def oneofDefine(self):
            return self.getTypedRuleContext(Empty_and_DevideParser.OneofDefineContext,0)


        def getRuleIndex(self):
            return Empty_and_DevideParser.RULE_atomFormSkeleton
    ...
    def atomFormSkeleton(self):
        ...
        localctx = Empty_and_DevideParser.AtomFormSkeletonContext(self, self._ctx, self.state)
        ...
        try:
            ...
            self._errHandler.sync(self)
            _la = self._input.LA(1)
            if _la==Empty_and_DevideParser.ONEOF:
                self.state = 132
                self.oneofDefine()
    ...
    class PredicateContext(ParserRuleContext):
        ...
        def getRuleIndex(self):
            return Empty_and_DevideParser.RULE_predicate
    ...
    def predicate(self):
        ...
        localctx = Empty_and_DevideParser.PredicateContext(self, self._ctx, self.state)
    ...
    class TypeDeclarationContext(ParserRuleContext):
        ...
        def constTerm(self, i:int=None):
            if i is None:
                return self.getTypedRuleContexts(Empty_and_DevideParser.ConstTermContext)
            else:
                return self.getTypedRuleContext(Empty_and_DevideParser.ConstTermContext,i)
        ...
        def getRuleIndex(self):
            return Empty_and_DevideParser.RULE_typeDeclaration
    ...
    def typeDeclaration(self):
        ...
        localctx = Empty_and_DevideParser.TypeDeclarationContext(self, self._ctx, self.state)
        self.enterRule(localctx, 18, self.RULE_typeDeclaration)
        try:
            self.state = 146
            self._errHandler.sync(self)
            token = self._input.LA(1)
            if token in [Empty_and_DevideParser.NAME]:
                self.enterOuterAlt(localctx, 1)
                self.state = 139
                self.match(Empty_and_DevideParser.NAME)
                pass
            elif token in [Empty_and_DevideParser.LB]:
                self.enterOuterAlt(localctx, 2)
                self.state = 140
                self.match(Empty_and_DevideParser.LB)
                self.state = 141
    ...
    class TypeContext(ParserRuleContext):
        ...
        def OBJECT(self):
            return self.getToken(Empty_and_DevideParser.OBJECT, 0)

        def AGENT(self):
            return self.getToken(Empty_and_DevideParser.AGENT, 0)

        def NAME(self):
            return self.getToken(Empty_and_DevideParser.NAME, 0)

        def getRuleIndex(self):
            return Empty_and_DevideParser.RULE_type
    ...
    def type(self):
        ...
        localctx = Empty_and_DevideParser.TypeContext(self, self._ctx, self.state)
        ...
        try:
            ...
            self.state = 148
            _la = self._input.LA(1)
            if not((((_la) & ~0x3f) == 0 and ((1 << _la) & ((1 << Empty_and_DevideParser.OBJECT) | (1 << Empty_and_DevideParser.AGENT) | (1 << Empty_and_DevideParser.NAME))) != 0)):
    ...
    class ActionDefineContext(ParserRuleContext):
        ...
        def COLON(self, i:int=None):
            if i is None:
                return self.getTokens(Empty_and_DevideParser.COLON)
            else:
                return self.getToken(Empty_and_DevideParser.COLON, i)

        def ACTION(self):
            return self.getToken(Empty_and_DevideParser.ACTION, 0)

        def actionSymbol(self):
            return self.getTypedRuleContext(Empty_and_DevideParser.ActionSymbolContext,0)
        ...
        def PARAMETER(self):
            return self.getToken(Empty_and_DevideParser.PARAMETER, 0)
        ...
        def PRECONDITION(self):
            return self.getToken(Empty_and_DevideParser.PRECONDITION, 0)
        ...
        def EFFECT(self):
            return self.getToken(Empty_and_DevideParser.EFFECT, 0)

        def emptyOrEffect(self):
            return self.getTypedRuleContext(Empty_and_DevideParser.EmptyOrEffectContext,0)


        def getRuleIndex(self):
            return Empty_and_DevideParser.RULE_actionDefine
    ...
    def actionDefine(self):
        ...
        localctx = Empty_and_DevideParser.ActionDefineContext(self, self._ctx, self.state)
        ...
        try:
            ...
            self.match(Empty_and_DevideParser.COLON)
            self.state = 152
            self.match(Empty_and_DevideParser.ACTION)
            self.state = 153
            self.actionSymbol()
            self.state = 160
            self._errHandler.sync(self)
            ...
            if la_ == 1:
                ...
                self.match(Empty_and_DevideParser.COLON)
                self.state = 155
                self.match(Empty_and_DevideParser.PARAMETER)
                self.state = 156
                self.match(Empty_and_DevideParser.LB)
                self.state = 157
                self.listVariable()
            ...
            if la_ == 1:
                ...
                self.match(Empty_and_DevideParser.COLON)
                self.state = 163
                self.match(Empty_and_DevideParser.PRECONDITION)
                self.state = 164
                self.emptyOrPreGD()
            ...
            self._errHandler.sync(self)
            _la = self._input.LA(1)
            if _la==Empty_and_DevideParser.COLON:
                self.state = 167
                self.match(Empty_and_DevideParser.COLON)
                self.state = 168
                self.match(Empty_and_DevideParser.EFFECT)
                self.state = 169
                self.emptyOrEffect()
    ...
    class ActionSymbolContext(ParserRuleContext):
        ...
        def getRuleIndex(self):
            return Empty_and_DevideParser.RULE_actionSymbol
    ...
    def actionSymbol(self):
        ...
        localctx = Empty_and_DevideParser.ActionSymbolContext(self, self._ctx, self.state)
    ...
    class EmptyOrPreGDContext(ParserRuleContext):
        ...
        def gd(self):
            return self.getTypedRuleContext(Empty_and_DevideParser.GdContext,0)
        ...
        def getRuleIndex(self):
            return Empty_and_DevideParser.RULE_emptyOrPreGD
    ...
    def emptyOrPreGD(self):
        ...
        localctx = Empty_and_DevideParser.EmptyOrPreGDContext(self, self._ctx, self.state)
    ...
    class EmptyOrEffectContext(ParserRuleContext):
        ...
        def effect(self):
            return self.getTypedRuleContext(Empty_and_DevideParser.EffectContext,0)
        ...
        def getRuleIndex(self):
            return Empty_and_DevideParser.RULE_emptyOrEffect
    ...
    def emptyOrEffect(self):
        ...
        localctx = Empty_and_DevideParser.EmptyOrEffectContext(self, self._ctx, self.state)
    ...
    class ListNameContext(ParserRuleContext):
        ...
        def NAME(self, i:int=None):
            if i is None:
                return self.getTokens(Empty_and_DevideParser.NAME)
            else:
                return self.getToken(Empty_and_DevideParser.NAME, i)

        def MINUS(self):
            return self.getToken(Empty_and_DevideParser.MINUS, 0)

        def type(self):
            return self.getTypedRuleContext(Empty_and_DevideParser.TypeContext,0)


        def listName(self):
            return self.getTypedRuleContext(Empty_and_DevideParser.ListNameContext,0)


        def getRuleIndex(self):
            return Empty_and_DevideParser.RULE_listName
    ...
    def listName(self):
        ...
        localctx = Empty_and_DevideParser.ListNameContext(self, self._ctx, self.state)
        ...
        try:
            ...
            if la_ == 1:
                ...
                self._errHandler.sync(self)
                _la = self._input.LA(1)
                while _la==Empty_and_DevideParser.NAME:
                    self.state = 186
                    self.match(Empty_and_DevideParser.NAME)
                    self.state = 191
                    self._errHandler.sync(self)
                ...
                self.state = 197
                self.match(Empty_and_DevideParser.MINUS)
                self.state = 198
                self.type()
                self.state = 199
                self.listName()
    ...
    class ListVariableContext(ParserRuleContext):
        ...
        def VAR(self, i:int=None):
            if i is None:
                return self.getTokens(Empty_and_DevideParser.VAR)
            else:
                return self.getToken(Empty_and_DevideParser.VAR, i)
        ...
        def getRuleIndex(self):
            return Empty_and_DevideParser.RULE_listVariable
    ...
    def listVariable(self):
        ...
        localctx = Empty_and_DevideParser.ListVariableContext(self, self._ctx, self.state)
        ...
        try:
            ...
            if la_ == 1:
                ...
                self._errHandler.sync(self)
                _la = self._input.LA(1)
                while _la==Empty_and_DevideParser.VAR:
                    self.state = 203
                    self.match(Empty_and_DevideParser.VAR)
                    self.state = 208
                    self._errHandler.sync(self)
                    _la = self._input.LA(1)
                ...
                while True:
                    ...
                    self._errHandler.sync(self)
                    _la = self._input.LA(1)
                    if not (_la==Empty_and_DevideParser.VAR):
                        break
    ...
    class OneofDefineContext(ParserRuleContext):
        ...
        def ONEOF(self):
            return self.getToken(Empty_and_DevideParser.ONEOF, 0)
        ...
        def getRuleIndex(self):
            return Empty_and_DevideParser.RULE_oneofDefine
    ...
    def oneofDefine(self):
        ...
        localctx = Empty_and_DevideParser.OneofDefineContext(self, self._ctx, self.state)
        self.enterRule(localctx, 34, self.RULE_oneofDefine)
        self._la = 0 # Token type
        try:
            self.enterOuterAlt(localctx, 1)
            self.state = 220
            self.match(Empty_and_DevideParser.ONEOF)
            self.state = 222 
            self._errHandler.sync(self)
            _la = self._input.LA(1)
            while True:
    ...
    class GdContext(ParserRuleContext):
        ...
        def termAtomForm(self):
            return self.getTypedRuleContext(Empty_and_DevideParser.TermAtomFormContext,0)
        ...
        def AND(self):
            return self.getToken(Empty_and_DevideParser.AND, 0)
        ...
        def gd(self, i:int=None):
            if i is None:
                return self.getTypedRuleContexts(Empty_and_DevideParser.GdContext)
            else:
                return self.getTypedRuleContext(Empty_and_DevideParser.GdContext,i)


        def OR(self):
            return self.getToken(Empty_and_DevideParser.OR, 0)

        def NOT(self):
            return self.getToken(Empty_and_DevideParser.NOT, 0)

        def IMPLY(self):
            return self.getToken(Empty_and_DevideParser.IMPLY, 0)

        def EXISTS(self):
            return self.getToken(Empty_and_DevideParser.EXISTS, 0)
        ...
        def FORALL(self):
            return self.getToken(Empty_and_DevideParser.FORALL, 0)

        def getRuleIndex(self):
            return Empty_and_DevideParser.RULE_gd
    ...
    def gd(self):
        ...
        localctx = Empty_and_DevideParser.GdContext(self, self._ctx, self.state)
        ...
        try:
            ...
            if la_ == 1:
                ...
                self.match(Empty_and_DevideParser.LB)
                self.state = 228
                self.match(Empty_and_DevideParser.AND)
                self.state = 230 
                self._errHandler.sync(self)
                _la = self._input.LA(1)
                while True:
                ...
                self.match(Empty_and_DevideParser.LB)
                self.state = 237
                self.match(Empty_and_DevideParser.OR)
                self.state = 239 
                self._errHandler.sync(self)
                _la = self._input.LA(1)
                while True:
                ...
                self.match(Empty_and_DevideParser.LB)
                self.state = 246
                self.match(Empty_and_DevideParser.NOT)
                self.state = 247
                self.gd()
                self.state = 248
                self.match(Empty_and_DevideParser.RB)
                ...
                self.match(Empty_and_DevideParser.LB)
                self.state = 251
                self.match(Empty_and_DevideParser.IMPLY)
                self.state = 252
                self.gd()
                self.state = 253
                self.gd()
                ...
                self.match(Empty_and_DevideParser.LB)
                self.state = 257
                self.match(Empty_and_DevideParser.EXISTS)
                self.state = 258
                self.match(Empty_and_DevideParser.LB)
                self.state = 259
                self.listVariable()
                ...
                self.match(Empty_and_DevideParser.LB)
                self.state = 265
                self.match(Empty_and_DevideParser.FORALL)
                self.state = 266
                self.match(Empty_and_DevideParser.LB)
                self.state = 267
                self.listVariable()
    ...
    class TermAtomFormContext(ParserRuleContext):
        ...
        def term(self, i:int=None):
            if i is None:
                return self.getTypedRuleContexts(Empty_and_DevideParser.TermContext)
            else:
                return self.getTypedRuleContext(Empty_and_DevideParser.TermContext,i)


        def EQ(self):
            return self.getToken(Empty_and_DevideParser.EQ, 0)

        def NEQ(self):
            return self.getToken(Empty_and_DevideParser.NEQ, 0)

        def LT(self):
            return self.getToken(Empty_and_DevideParser.LT, 0)

        def LEQ(self):
            return self.getToken(Empty_and_DevideParser.LEQ, 0)

        def GT(self):
            return self.getToken(Empty_and_DevideParser.GT, 0)

        def GEQ(self):
            return self.getToken(Empty_and_DevideParser.GEQ, 0)

        def getRuleIndex(self):
            return Empty_and_DevideParser.RULE_termAtomForm
    ...
    def termAtomForm(self):
        ...
        localctx = Empty_and_DevideParser.TermAtomFormContext(self, self._ctx, self.state)
        ...
        try:
            ...
            if la_ == 1:
                ...
                self._errHandler.sync(self)
                _la = self._input.LA(1)
                while (((_la) & ~0x3f) == 0 and ((1 << _la) & ((1 << Empty_and_DevideParser.LB) | (1 << Empty_and_DevideParser.NAME) | (1 << Empty_and_DevideParser.INTEGER) | (1 << Empty_and_DevideParser.VAR))) != 0):
                    self.state = 276
                    self.term()
                    self.state = 281
                    self._errHandler.sync(self)
                ...
                self.match(Empty_and_DevideParser.LB)
                self.state = 285
                self.match(Empty_and_DevideParser.EQ)
                self.state = 286
                self.term()
                self.state = 287
                self.term()
                ...
                self.match(Empty_and_DevideParser.LB)
                self.state = 291
                self.match(Empty_and_DevideParser.NEQ)
                self.state = 292
                self.term()
                self.state = 293
                self.term()
                ...
                self.match(Empty_and_DevideParser.LB)
                self.state = 297
                self.match(Empty_and_DevideParser.LT)
                self.state = 298
                self.term()
                self.state = 299
                self.term()
                ...
                self.match(Empty_and_DevideParser.LB)
                self.state = 303
                self.match(Empty_and_DevideParser.LEQ)
                self.state = 304
                self.term()
                self.state = 305
                self.term()
                ...
                self.match(Empty_and_DevideParser.LB)
                self.state = 309
                self.match(Empty_and_DevideParser.GT)
                self.state = 310
                self.term()
                self.state = 311
                self.term()
                ...
                self.match(Empty_and_DevideParser.LB)
                self.state = 315
                self.match(Empty_and_DevideParser.GEQ)
                self.state = 316
                self.term()
                self.state = 317
                self.term()
    ...
    class TermLiteralContext(ParserRuleContext):
        ...
        def getRuleIndex(self):
            return Empty_and_DevideParser.RULE_termLiteral
    ...
    def termLiteral(self):
        ...
        localctx = Empty_and_DevideParser.TermLiteralContext(self, self._ctx, self.state)
    ...
    class ConstTermContext(ParserRuleContext):
        ...
        def INTEGER(self):
            return self.getToken(Empty_and_DevideParser.INTEGER, 0)
        ...
        def PLUS(self):
            return self.getToken(Empty_and_DevideParser.PLUS, 0)

        def getRuleIndex(self):
            return Empty_and_DevideParser.RULE_constTerm
    ...
    def constTerm(self):
        ...
        localctx = Empty_and_DevideParser.ConstTermContext(self, self._ctx, self.state)
        ...
        try:
            ...
            if la_ == 1:
                ...
                self.enterOuterAlt(localctx, 2)
                self.state = 331
                self.match(Empty_and_DevideParser.INTEGER)
                pass
                ...
                self.match(Empty_and_DevideParser.LB)
                self.state = 344
                self.match(Empty_and_DevideParser.PLUS)
                self.state = 345
                self.constTerm()
                self.state = 346
                self.constTerm()
    ...
    class TermContext(ParserRuleContext):
        ...
        def VAR(self):
            return self.getToken(Empty_and_DevideParser.VAR, 0)
        ...
        def getRuleIndex(self):
            return Empty_and_DevideParser.RULE_term
    ...
    def term(self):
        ...
        localctx = Empty_and_DevideParser.TermContext(self, self._ctx, self.state)
    ...
    class EffectContext(ParserRuleContext):
        ...
        def pEffect(self, i:int=None):
            if i is None:
                return self.getTypedRuleContexts(Empty_and_DevideParser.PEffectContext)
            else:
                return self.getTypedRuleContext(Empty_and_DevideParser.PEffectContext,i)


        def getRuleIndex(self):
            return Empty_and_DevideParser.RULE_effect
    ...
    def effect(self):
        ...
        localctx = Empty_and_DevideParser.EffectContext(self, self._ctx, self.state)
    ...
    class AssignopContext(ParserRuleContext):
        ...
        def INC(self):
            return self.getToken(Empty_and_DevideParser.INC, 0)

        def DEC(self):
            return self.getToken(Empty_and_DevideParser.DEC, 0)

        def ASSGIN(self):
            return self.getToken(Empty_and_DevideParser.ASSGIN, 0)

        def getRuleIndex(self):
            return Empty_and_DevideParser.RULE_assignop
    ...
    def assignop(self):
        ...
        localctx = Empty_and_DevideParser.AssignopContext(self, self._ctx, self.state)
        ...
        try:
            ...
            self.state = 385
            _la = self._input.LA(1)
            if not((((_la) & ~0x3f) == 0 and ((1 << _la) & ((1 << Empty_and_DevideParser.INC) | (1 << Empty_and_DevideParser.DEC) | (1 << Empty_and_DevideParser.ASSGIN))) != 0)):
                self._errHandler.recoverInline(self)
            else:
                self._errHandler.reportMatch(self)
                self.consume()
    ...
    class PEffectContext(ParserRuleContext):
        ...
        def assignop(self):
            return self.getTypedRuleContext(Empty_and_DevideParser.AssignopContext,0)
        ...
        def term(self):
            return self.getTypedRuleContext(Empty_and_DevideParser.TermContext,0)
        ...
        def getRuleIndex(self):
            return Empty_and_DevideParser.RULE_pEffect
    ...
    def pEffect(self):
        ...
        localctx = Empty_and_DevideParser.PEffectContext(self, self._ctx, self.state)
    ...
    class ProblemNameContext(ParserRuleContext):
        ...
        def getRuleIndex(self):
            return Empty_and_DevideParser.RULE_problemName
    ...
    def problemName(self):
        ...
        localctx = Empty_and_DevideParser.ProblemNameContext(self, self._ctx, self.state)
    ...
    class DomainNameContext(ParserRuleContext):
        ...
        def getRuleIndex(self):
            return Empty_and_DevideParser.RULE_domainName
    ...
    def domainName(self):
        ...
        localctx = Empty_and_DevideParser.DomainNameContext(self, self._ctx, self.state)
    ...
    class AgentDefineContext(ParserRuleContext):
        ...
        def getRuleIndex(self):
            return Empty_and_DevideParser.RULE_agentDefine
    ...
    def agentDefine(self):
        ...
        localctx = Empty_and_DevideParser.AgentDefineContext(self, self._ctx, self.state)
        ...
        try:
            ...
            self.match(Empty_and_DevideParser.COLON)
            self.state = 399
            self.match(Empty_and_DevideParser.AGENT)
            self.state = 401 
            self._errHandler.sync(self)
            _la = self._input.LA(1)
            while True:
    ...
    class ObjectDeclarationContext(ParserRuleContext):
        ...
        def getRuleIndex(self):
            return Empty_and_DevideParser.RULE_objectDeclaration
    ...
    def objectDeclaration(self):
        ...
        localctx = Empty_and_DevideParser.ObjectDeclarationContext(self, self._ctx, self.state)
    ...
    class NumericSettingContext(ParserRuleContext):
        ...
        def INTEGER(self, i:int=None):
            if i is None:
                return self.getTokens(Empty_and_DevideParser.INTEGER)
            else:
                return self.getToken(Empty_and_DevideParser.INTEGER, i)

        def getRuleIndex(self):
            return Empty_and_DevideParser.RULE_numericSetting
    ...
    def numericSetting(self):
        ...
        localctx = Empty_and_DevideParser.NumericSettingContext(self, self._ctx, self.state)
    ...
    class InitContext(ParserRuleContext):
        ...
        def INIT(self):
            return self.getToken(Empty_and_DevideParser.INIT, 0)
        ...
        def constTermAtomForm(self, i:int=None):
            if i is None:
                return self.getTypedRuleContexts(Empty_and_DevideParser.ConstTermAtomFormContext)
            else:
                return self.getTypedRuleContext(Empty_and_DevideParser.ConstTermAtomFormContext,i)


        def getRuleIndex(self):
            return Empty_and_DevideParser.RULE_init
    ...
    def init(self):
        ...
        localctx = Empty_and_DevideParser.InitContext(self, self._ctx, self.state)
        ...
        try:
            ...
            self.match(Empty_and_DevideParser.COLON)
            self.state = 429
            self.match(Empty_and_DevideParser.INIT)
            self.state = 433
            self._errHandler.sync(self)
            _la = self._input.LA(1)
            while _la==Empty_and_DevideParser.LB:
    ...
    class ConstTermAtomFormContext(ParserRuleContext):
        ...
        def getRuleIndex(self):
            return Empty_and_DevideParser.RULE_constTermAtomForm
    ...
    def constTermAtomForm(self):
        ...
        localctx = Empty_and_DevideParser.ConstTermAtomFormContext(self, self._ctx, self.state)
        ...
        try:
            ...
            if la_ == 1:
                ...
                self._errHandler.sync(self)
                _la = self._input.LA(1)
                while (((_la) & ~0x3f) == 0 and ((1 << _la) & ((1 << Empty_and_DevideParser.LB) | (1 << Empty_and_DevideParser.NAME) | (1 << Empty_and_DevideParser.INTEGER))) != 0):
                    self.state = 440
                    self.constTerm()
                    self.state = 445
                    self._errHandler.sync(self)
